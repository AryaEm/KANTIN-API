...
import { createTransaksi, deleteOrder, getIncome, getOrder, getPendingTransactionCount, getSiswaHistory, getSiswaOngoingOrder, getStanHistory, getStanHistorySelesai, rejectOrder, updateStatus } from "../controllers/order"
...
app.get("/history/siswa", [verifyToken, verifyRole(["siswa"]), verifyGetSiswaHistory], getSiswaHistory)
